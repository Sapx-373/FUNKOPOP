const funkoCard =[
    {
        link: "https://sapxblend.gumroad.com/l/jqwfjt",
        img1: "./img/ywach.png",
    ...
    },
    {
        ...
        img1: "/img/HisagiBANKAI.png",
        img2: "/img/HisagiBANKAI2.png",
        nombre: "Hisagi Bankai",
        franquicia: "BLEACH FUNKO POP",
        precio: "8.99"
    },
    {
        link: "https://sapxblend.gumroad.com/l/orlbv",
        img1: "/img/IKKAKU.png",
 ...
 Popcards = document.querySelector(".cards")

 const cardFull = funkoCard.map(card =>`
     <li class="card">
         <a href=${card.link} target="_blank" rel="noopener norefercer">
             <div class="gif_container">
                 <img src=${card.img1} alt="img01Color">
                 <img src=${card.img2} alt="">
             </div>
             <div class="infocard">
                 <p>${card.nombre}<br/>${card.franquicia}</p>
                 <p><ion-icon name="star-outline"></ion-icon> 5.0</p>
             </div>
             <div class="price">
                 <p>${card.precio}</p>           
             </div>
